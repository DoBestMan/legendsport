 ...
 * TournamentEvents
 *
 * @ORM\Table(name="tournament_events", indexes={@ORM\Index(name="tournament_events_api_event_id_foreign", columns={"api_event_id"}), @ORM\Index(name="tournament_events_tournament_id_foreign", columns={"tournament_id"})})
 * @ORM\Entity
 */
