...
class ApiEventToOdds extends TransformerAbstract
{
    public function transform(ApiEvent $apiEvent)
    {
        ...
        return [
            ...
            "point_spread_home_line" => isset($odds[SpreadHome::class]) ? $odds[SpreadHome::class]->getHandicap() : null,
            "point_spread_away_line" => isset($odds[SpreadAway::class]) ? $odds[SpreadAway::class]->getHandicap() : null,
