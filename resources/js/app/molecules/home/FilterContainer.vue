<template>
    <div class="row">
        <div class="col-1">
            ...
            <MultiSelect id="type" :options="typeOptions" v-model="tournamentListStore.type" />
        </div>
        ...
        <div class="col-1">
            ...
            <MultiSelect id="buy-in" :options="buyInOptions" v-model="tournamentListStore.buyIn" />
        </div>
