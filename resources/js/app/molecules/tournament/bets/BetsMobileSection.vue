<template>
    <section
        class="layout__content__sidebar layout__content__sidebar--active"
    ...
    >
        <div class="layout__content__sidebar__header">
            <div class="layout__content__sidebar__header__bet" v-if="isRegistered">
                <i class="icon m--r--2 icon--left" @click="backMatchSection"></i>
            ...
            <div class="layout__content__sidebar__header__bet" v-else>
                <i class="icon m--r--2 icon--left" @click="backMatchSection"></i>
                <div class="layout__content__sidebar__header__bet__content" style="width:20%;">
                    <div class="layout__content__sidebar__header__bet__content__title">
                        Bet Slip
                    </div>
                </div>
                <RegisterNowButton class="button--large" :tournament="tournament" />
            </div>
            ...
            >
                ...
                <div
                    class="button button--small button--yellow m--l--4"
                    @click="updateOddsWager"
                    style="width: 50%;"
                >
                    SET TO ALL
                </div>
