...
/**
 * @covers App\Domain\BetTypes\MoneyLineHome
 ...
 */
class MoneyLineHomeTest extends TestCase
{
    ...
    public function testEvaluate($home, $away, $result)
    {
        ...
        $tournament->placeStraightBet($player, 1000, new BetItem(MoneyLineHome::class, $tournamentEvent));
