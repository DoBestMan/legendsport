...
use App\Tournament\Evaluation\TotalOverEvaluator;
use Decimal\Decimal;
use Tests\Utils\UnitTestCase;

class TotalOverEvaluatorTest extends UnitTestCase
{
    /** @test */
    public function mark_as_win()
    {
        ...
        $apiEvent->score_home = 23;
        $apiEvent->score_away = 20;

        // when
        $betStatus = (new TotalOverEvaluator())->evaluate($apiEvent, new Decimal("42.5"));
    ...
    public function mark_as_push()
    {
        ...
        // when
        $betStatus = (new TotalOverEvaluator())->evaluate($apiEvent, new Decimal("51"));
